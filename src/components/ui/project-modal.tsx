      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-white rounded-3xl p-5 sm:p-10 shadow-2xl border border-slate-200 z-10 max-h-[90vh] overflow-y-auto my-auto"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 sm:top-5 sm:right-5 p-2 rounded-full text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-600 z-20"
            ...
            {!isSubmitted ? (
              <div>
                ...
                <h3
                  id="modal-title"
                  className="text-xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mb-2 pr-6"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {services.map((srv) => (
                        <button
                          ...
                          className={`text-xs font-semibold px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-full transition-all border ${
                            selectedService === srv
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2 sm:py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2 sm:py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent transition-all resize-none"
                    />
                  </div>
