...
export function SelectedWork() {
  return (
    <section id="work" className="py-20 sm:py-28 bg-slate-50/50">
      <Container size="wide">
        <SectionHeading
          eyebrow="OUR WORK"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectsData.map((project, index) => (
            ...
            >
              <Card className="h-full flex flex-col justify-between overflow-hidden p-0 group border border-slate-200/80 bg-white">
